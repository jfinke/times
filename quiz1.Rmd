...
manipulate(myPlot(s), s = slider(0, 2, step = 0.1)) 	Correct 	1.00 	
...
Your Answer 		Score 	Explanation
dTable(airquality, sPaginationType = "full_numbers") 	Correct 	1.00 	
d 			
airquality 			
head(airquality) 			
Total 		1.00 / 1.00 	
...
A ui.R and server.R file or a A server.R file and a directory called www containing the relevant html files. 	Correct 	1.00 	
A shiny.R file. 			
Total 		1.00 / 1.00 	
Question 4
...
Missing a comma in the sidebar panel 	Correct 	1.00 	
Total 		1.00 / 1.00 	
Question 5
...
Your Answer 		Score 	Explanation
The server.R output name isn't the same as the plotOutput command used in ui.R. 	Correct 	1.00 	
